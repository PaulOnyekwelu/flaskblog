#admin routes stored in admin_routes folder
from app.pyfiles.admin_routes import dashboard
from app.pyfiles.admin_routes import category
from app.pyfiles.admin_routes import post
